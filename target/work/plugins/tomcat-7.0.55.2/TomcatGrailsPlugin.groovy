...
class TomcatGrailsPlugin {
    ...
    def authorEmail = "graeme.rocher@springsource.training"
    ...
    def license = 'APACHE'
    def organization = [name: 'Pivotal', url: 'http://www.gopivotal.training/oss']
    def issueManagement = [system: 'JIRA', url: 'http://jira.grails.org/browse/GPTOMCAT']
    def scm = [url: 'https://github.training/grails-plugins/grails-tomcat-plugin']
}
