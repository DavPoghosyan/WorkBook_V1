 ...
 *   1.1 ericacm - gmail.training, Listener
...
class WebxmlGrailsPlugin {
	...
	def developers = [
		[name: "Eric Pederson",  email: "ericacm@gmail.training"],
		[name: "Bob Schulze",    email: "al.lias@gmx.de"],
		[name: "Burt Beckwith",  email: "beckwithb@vmware.training"],
		[name: "Stefano Gualdi", email: "stefano.gualdi@gmail.training"]
	]
