...
<div id="company-info" title="${message(code: 'company.info.label')}">
    <li class="fieldcontain">
        <span id="company-name-label" class="modal-property-label">
            <g:message code="name.label"/>
        </span>
        <span class="modal-property-value" aria-labelledby="company-name-label">
            <g:fieldValue bean="${company}" field="name"/>
        </span>
    </li>
    <li class="fieldcontain">
        <span id="company-description-label" class="modal-property-label">
            <g:message code="description.label"/>
        </span>
        <span class="modal-property-value" aria-labelledby="company-description-label">
